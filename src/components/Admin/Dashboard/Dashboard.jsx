import { Box, Grid,Heading,Text,HStack,Stack, Progress } from '@chakra-ui/react'
    ...
    templateColumns={['1fr','5fr 1fr']}>
      ...
      px={['4','0']}>
        ...
        justifyContent='space-evenly'>
          ...
          <Databox title="Subscription" qty={56} qtyPercentage="20" profit={false} />
        ...
        <Box
          ...
          <Grid templateColumns={['1fr', 'repeat(2, 1fr)']}>
            ...
            <Box p={['0','16']}
            boxSizing='border-box' py={'4'} w={"70%"}
            >
